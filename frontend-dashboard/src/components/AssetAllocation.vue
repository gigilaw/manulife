    ...
    <v-card-text>
      <v-row align="center">
        <template v-if="assets.length > 0">
          <v-col class="d-flex flex-column justify-center" cols="12" md="7">
        ...
        <div v-else class="text-center py-8 w-100">
          <v-icon class="mb-4" color="grey-lighten-2" size="64">mdi-chart-pie</v-icon>
          ...
          <div class="pie-legend">
            ...
            >
              <div class="d-flex align-center">
                <div class="legend-color mr-3" :style="{ backgroundColor: item.color }" />
