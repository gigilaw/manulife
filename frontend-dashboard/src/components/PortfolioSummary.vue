<template>
  <v-row class="mb-6">
    ...
    <v-col cols="12" sm="6" md="3">
      <v-card class="pa-4" elevation="2" :class="cardClass(summary.totalGainLoss)">
    ...
    <v-col cols="12" sm="6" md="3">
      <v-card class="pa-4" elevation="2" :class="cardClass(summary.totalReturnPercentage)">
        <div class="d-flex justify-space-between align-center">
