...
<script setup lang="ts">
  import type { Asset, AssetForm, Portfolio, User } from '../types/dashboard'
  ...
  // Methods
  function openAddAssetModal (): void {
    editingAsset.value = null
    showAssetModal.value = true
  }

  function openEditAssetModal (asset: Asset): void {
    editingAsset.value = asset // This will trigger the modal to populate
    showAssetModal.value = true
  }

  function openDeleteAssetModal (asset: Asset): void {
  ...
  async function saveAsset (formData: AssetForm): Promise<void> {
    loading.value = true
    errorMessage.value = ''
    ...
    try {
      ...
      await (editingAsset.value
        ? api.put(`/portfolio/${portfolioId}/assets/${editingAsset.value.id}`, {
          quantity: assetData.quantity,
          price: assetData.price,
        })
        : api.post(`/portfolio/${portfolioId}/assets`, assetData))
